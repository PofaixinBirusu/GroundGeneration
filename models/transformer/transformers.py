...
class TransformerSelfEncoder(nn.Module):
    ...
    def forward(self, src, tgt,
        ...
        for layer in self.layers:
            src, _ = layer(src, tgt, src_mask=src_mask, tgt_mask=tgt_mask,
        ...
        if self.return_intermediate:
            return torch.stack(src_intermediate)
    ...
    def get_attentions(self):
        ...
        for layer in self.layers:
            src_satt, _ = layer.satt_weights
            src_xatt, _ = layer.xatt_weights
        ...
        return (src_satt_all, None), (src_xatt_all, None)
