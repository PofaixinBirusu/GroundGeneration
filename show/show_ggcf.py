...
from models.network import GGCFNet

cfg = Config()
# model
param_save_path = "../params/ggcf.pth"
net = GGCFNet(config=cfg)
net.to(cfg.device)
...
def show_ground_generation(net, test_loader):
    ...
    with torch.no_grad():
        for c_iter in range(num_iter):
            ...
            # 展示 物体 + 标签
            o3d.draw_geometries([objects_pc, ground_gt_pc], window_name="generation", width=1000, height=800)
            # 展示标签
